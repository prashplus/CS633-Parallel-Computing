...
int main(int argc, char *argv[])
{
    ...
    MPI_Reduce(&sumPreTime,&avgPreProTime,1,MPI_DOUBLE,MPI_MAX,0,MPI_COMM_WORLD);
    MPI_Reduce(&sumClusTime,&avgClusTime,1,MPI_DOUBLE,MPI_MAX,0,MPI_COMM_WORLD);
